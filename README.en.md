...
> Rounds 15–17 and the macOS binary-probe fix are **committed but not yet released** (npm's latest is `0.1.21`): macOS users and anyone who needs those fixes should install from git, or wait for the next release.
